...
func (s *RulesService) Create(opt *RulesCreateOption) (Resp *RulesCreateResp, err error) {
...
func (s *RulesService) Delete(opt *RulesDeleteOption) (Resp *RulesDeleteResp, err error) {
...
// [TODO] you should call the <Repositories> func manually and complete the fields of this struct
type RulesRepositoriesResp struct{}
...
func (s *RulesService) Repositories(opt *RulesRepositoriesOption) (Resp *RulesRepositoriesResp, err error) {
...
func (s *RulesService) Search(opt *RulesSearchOption) (Resp *RulesSearchResp, err error) {
...
func (s *RulesService) Show(opt *RulesShowOption) (Resp *RulesShowResp, err error) {
...
// Tags List rule tags
func (s *RulesService) Tags(opt *RulesTagsOption) (Resp *RulesTagsResp, err error) {
...
func (s *RulesService) Update(opt *RulesUpdateOption) (Resp *RulesUpdateResp, err error) {
